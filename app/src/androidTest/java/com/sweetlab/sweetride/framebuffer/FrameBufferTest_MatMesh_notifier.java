    ...
    protected void setUp() throws Exception {
        ...
        runOnGLThread(new ResultRunnable() {
            ...
            public Object run() {
                ...
                mContext.getActionHandler().handleActions(mTriangleMaterial);
                mContext.getActionHandler().handleActions(mQuadMaterial);
                mContext.getActionHandler().handleActions(mTriangleMesh);
                mContext.getActionHandler().handleActions(mQuadMesh);
