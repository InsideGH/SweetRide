...
public class FrameBufferTest_Geometry_notifier extends OpenGLTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        runOnGLThread(new ResultRunnable() {
            ...
            public Object run() {
                ...
                mContext.getActionHandler().handleActions(mTriangle);
                mContext.getActionHandler().handleActions(mQuad);
