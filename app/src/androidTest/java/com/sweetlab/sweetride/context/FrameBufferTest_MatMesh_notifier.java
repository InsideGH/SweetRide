...
public class FrameBufferTest_MatMesh_notifier extends OpenGLTestCase {
    /**
     * Backend context.
     */
    ...
    protected void setUp() throws Exception {
        ...
        runOnGLThread(new ResultRunnable() {
            ...
            public Object run() {
                ...
                ActionHelper.handleGLThreadActions(mTriangleMaterial, mContext);
                ActionHelper.handleGLThreadActions(mQuadMaterial, mContext);
                ActionHelper.handleGLThreadActions(mTriangleMesh, mContext);
                ActionHelper.handleGLThreadActions(mQuadMesh, mContext);
                ActionHelper.handleGLThreadActions(mFrameBuffer, mContext);

                assertFalse(mTriangleMaterial.hasActions());
                assertFalse(mQuadMaterial.hasActions());
                assertFalse(mTriangleMesh.hasActions());
                assertFalse(mQuadMesh.hasActions());
    ...
    public void testFrameBufferTest_MatMesh_notifier() {
